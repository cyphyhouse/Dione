...
{ (((para.u0!=max(para.u0, para.u1, para.u2)) ==> (s.P0.status==UNKNOWN))&&((para.u1!=max(para.u0, para.u1, para.u2)) ==> (s.P1.status==UNKNOWN))&&((para.u2!=max(para.u0, para.u1, para.u2)) ==> (s.P2.status==UNKNOWN))) }
